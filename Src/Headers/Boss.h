...
private:
	...
	// Custom behaviour phases
	enum class BossPhase { Strafe, Aggressive };
	BossPhase phase;

	float strafeAngle;      // tracks circular strafe position
	float strafeRadius;     // how far from player boss tries to stay
